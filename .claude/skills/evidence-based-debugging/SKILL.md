...
description: Workflow passo-a-passo para depurar bugs baseando-se em evidências e injeção de logs em vez de adivinhação cega. Invoque esta skill quando estiver lidando com um erro de lógica ("estado não atualizando", "loop infinito", etc) no ecossistema do Robot Runner (React ou Rust). (Convertido de .agents/skills/evidence-based-debugging/SKILL.md)
---
