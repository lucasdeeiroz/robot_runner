...
import com.lucasdeeiroz.robotrunner.hardware.DisplayTestActivity
...
class CompanionHttpServer(
    ...
    override fun serve(session: IHTTPSession): Response {
        ...
        val responseJson = when (uri) {
            ...
            "/network/interfaces" -> {
                val array = JsonArray()
                val interfaces = kotlinx.coroutines.runBlocking { com.lucasdeeiroz.robotrunner.net.NetworkInspector.getNetworkInterfaces() }
            ...
            "/logcat/recent" -> {
                val array = JsonArray()
                val recentLogs = com.lucasdeeiroz.robotrunner.logcat.LogcatStreamer.getFilteredLogs()
            ...
            "/performance/history" -> {
                val array = JsonArray()
                val history = com.lucasdeeiroz.robotrunner.performance.PerformanceCollector.getHistorySnapshot()
            ...
            "/stopwatch/stop" -> {
                val benchSession = com.lucasdeeiroz.robotrunner.stopwatch.RedrawStopwatchEngine.stopSession()
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/stopwatch/laps" -> {
                val laps = com.lucasdeeiroz.robotrunner.stopwatch.RedrawStopwatchEngine.getLapsSnapshot()
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/bdd/status" -> {
                JsonObject().apply {
                    addProperty("status", "ok")
                    addProperty("isRunning", com.lucasdeeiroz.robotrunner.bdd.BddRunnerEngine.isRunning)
                    addProperty("currentStep", com.lucasdeeiroz.robotrunner.bdd.BddRunnerEngine.currentStepDescription)
                }
            }

            "/inspector/tree" -> {
                val elements = com.lucasdeeiroz.robotrunner.inspector.UiInspectorEngine.captureActiveUiTree()
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/inspector/map" -> {
                val elements = com.lucasdeeiroz.robotrunner.inspector.UiInspectorEngine.getCapturedElementsSnapshot()
                JsonObject().apply {
                    addProperty("status", "ok")
                    add("elements", gson.toJsonTree(elements))
                }
            ...
            "/explorer/start" -> {
                com.lucasdeeiroz.robotrunner.explorer.AutonomousExplorerEngine.startExploration()
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/explorer/stop" -> {
                com.lucasdeeiroz.robotrunner.explorer.AutonomousExplorerEngine.stopExploration()
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/explorer/status" -> {
                val report = com.lucasdeeiroz.robotrunner.explorer.AutonomousExplorerEngine.reportFlow.value
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/golden/verify" -> {
                val verification = com.lucasdeeiroz.robotrunner.checkup.UiTextVerifier.verifyActiveScreenText()
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/checkup/pdf" -> {
                ...
                val uiText = com.lucasdeeiroz.robotrunner.checkup.UiTextVerifier.verifyActiveScreenText()
            ...
            "/sync/artifacts" -> {
                val syncManager = com.lucasdeeiroz.robotrunner.sync.SyncManager(context)
            ...
            "/fleet/peers" -> {
                val peers = com.lucasdeeiroz.robotrunner.sync.FleetP2pBridge.peersFlow.value
                JsonObject().apply {
                    addProperty("status", "ok")
            ...
            "/sync/theme" -> {
                try {
                    ...
                    com.lucasdeeiroz.robotrunner.sync.ThemeSyncManager.updateTheme(
                        theme = theme,
