export const pt = {
    translation: {
        ...
        apps: {
            ...
            update_companion: "Atualizar Companion.apk",
            update_companion_tooltip: "Atualizar companion.apk para release atual ({{version}})",
            updating_companion: "Abrindo link de atualização do companion.apk ({{version}})...",
        ...
        connect: {
            ...
            labels: {
                target_device: "Dispositivo USB Alvo",
                ip: "Endereço IP",
                port: "Porta",
        ...
        toolbox: {
            ...
            checkup: {
                ...
                expected: "Esperado",
                found: "Encontrado",
                interactive_tests: "Testes Interativos de Hardware",
                live_sync: "Sincronização Ao Vivo",
                offline: "Offline",
                no_interactive_tests: "Nenhum teste interativo executado ainda. Execute-os no app Companion.",
                test_scanner: "Scanner",
                test_pixels: "Cores da Tela",
                test_touch: "Toque na Tela",
                test_vibration: "Vibração",
                test_speaker: "Alto-falante",
                test_mic: "Microfone",
                test_flash: "Flash da Câmera",
                test_printer: "Impressora Térmica",
                ...
                clear: "Limpar",
                golden_file_imported: "Arquivo Golden importado com sucesso!",
                golden_file_import_error: "Falha ao importar arquivo Golden",
                golden_file: {
                    generating: "Gerando arquivo Golden...",
                    saved: "Arquivo Golden salvo com sucesso!",
                    error: "Falha ao gerar arquivo Golden"
                },
                report_title: "Relatório de Checkup do Dispositivo",
                device_name: "Nome do Dispositivo",
                device_udid: "UDID do Dispositivo",
                date: "Data",
                log_copied: "Log copiado para a área de transferência",
                check_os: "Check OS",
                generate_golden_file: "Gerar Golden File",
                import_golden_file: "Importar Golden File",
                generating_golden_file: "Gerando golden file...",
                base_props: {
                    config_title: "Configuração de Base Props",
                    config_desc: "Configure os prefixos usados para buscar as propriedades base (base props) para o golden file e para a lista de comparação de propriedades.",
                    prefixes: "Prefixos (ex: ro.build)",
                    add_prefix: "Adicionar prefixo..."
                },
                search_config: {
                    config_title: "Configuração de Pesquisa",
                    config_desc: "Configure os filtros de pesquisa de propriedades (.prop) e aplicativos instalados (pacotes) para inspeção, comparação e geração de relatórios.",
                    props_section_title: "Propriedades do Dispositivo (.prop)",
                    props_section_desc: "Prefixos de propriedades a serem consultadas e comparadas (ex: ro.build, ro.product).",
                    props_prefixes: "Prefixos de Propriedades",
                    packages_section_title: "Aplicativos Instalados (Pacotes)",
                    packages_section_desc: "Filtros de pacotes a serem consultados e exibidos na interface e no relatório.",
                    packages_mode_exclude: "Excluir Prefixos",
                    packages_mode_include: "Apenas Incluir",
                    packages_prefixes: "Prefixos de Pacotes",
                    add_prefix: "Adicionar prefixo...",
                    reset_defaults: "Restaurar Padrões",
                },
                search_config_btn: "Configurar Pesquisa",
                ...
                report: {
                    analyst_name: 'Nome do Analista',
                    analyst_placeholder: 'Digite o nome do analista / QA',
                    analyst_required_warning: 'Campo obrigatório: O relatório não pode ser gerado sem o nome do analista.',
                    result: 'Resultado Final',
                    approved: 'Aprovado',
                    rejected: 'Reprovado',
                    pending: 'Pendente',
                    ai_evaluating: 'Em Avaliação por IA',
                    comments: 'Comentários / Observações',
                    comments_placeholder: 'Adicione observações gerais, justificativas ou notas do teste...',
                    no_comments: 'Nenhuma observação registrada.',
                    compliant_summary: '{{count}} itens conformes',
                    compliant_hidden: 'itens conformes',
                    unverified_sections_error: 'Por favor, ateste/verifique (Conferido) todas as seções ativas antes de gerar o relatório: {{sections}}',
                    sections_to_include: 'Seções a Incluir no Relatório',
                    ...
                    standard_checks_title_alt: 'Mostrar Checagens Padrão',
                    standard_checks_desc: 'Incluir os resultados das checagens padrão se executadas',
                    additional_checks_title_alt: 'Mostrar Checagens Adicionais',
                    additional_checks_desc: 'Incluir os resultados das checagens adicionais se executadas',
                    packages_title_alt: 'Mostrar Pacotes',
                    packages_desc: 'Incluir os resultados da checagem de pacotes se executada',
                    companion_bdd_title: 'Testes BDD do Companion',
                    companion_bdd_desc: 'Incluir relatórios de execução BDD mobile',
                    manual_checks_title: 'Checagens Manuais',
                    manual_checks_desc: 'Incluir inspeções visuais personalizadas e fotos',
                    ui_texts_title: 'Verificações de Texto de UI',
                    ui_texts_desc: 'Incluir OCR de tela e validação de textos',
                    interactive_tests_title: 'Hardware Interativo',
                    interactive_tests_desc: 'Incluir checagens de touchscreen e botões',
                    extra_props_title: 'Mostrar Propriedades Adicionais',
                    extra_props_desc: 'Incluir as propriedades adicionais do dispositivo',
                    only_divergent: 'Mostrar apenas valores não correspondentes',
                    btn_exclude: 'Mostrar todos exceto...',
                    btn_include: 'Mostrar APENAS...',
                    advanced_filters: 'Filtros Avançados',
                    packages_filter: 'Filtro de Pacotes',
                    props_filter: 'Filtro de Propriedades Extra',
                ...
                no_packages_found: "Nenhum pacote encontrado ou dispositivo não conectado.",
                no_props: "Nenhuma propriedade carregada. Clique em \"Importar Props\" ou conecte o Companion.",
                package_name: "Pacote",
                version: "Versão",
                match: "Confere",
                mismatch: "Divergente",
                ...
                fetching_packages: "Buscando aplicativos instalados...",
                show_only_divergent: "Apenas Divergências",
                error_fetch: "Falha ao buscar as propriedades do dispositivo",
                status_match: "Confere",
                ...
                system: "Sistema",
                user: "Usuário",
                search_pkg: "Pesquisar aplicativo...",
                companion_bdd_tests: "Testes BDD do Companion",
                syncing_companion_tests: "Sincronizando testes do Companion...",
                no_companion_tests: "Nenhuma suíte de testes BDD encontrada. Crie ou execute testes no aplicativo Companion para sincronizá-los aqui.",
                manual_checks: "Checagens Manuais",
                add_check: "Adicionar Checagem",
                add_manual_check: "Adicionar Checagem Manual",
                edit_manual_check: "Editar Checagem Manual",
                no_manual_checks: "Nenhuma checagem manual adicionada ainda. Clique em \"Adicionar Checagem\" para registrar inspeções visuais/hardware personalizadas.",
                no_ui_text_checks: "Nenhuma verificação de texto de UI configurada. Clique em \"Adicionar\" para configurar testes de extração de texto da tela.",
                no_divergences: "Nenhuma divergência encontrada.",
                value_type: "Tipo de Evidência / Valor",
                manual_name_placeholder: "Ex: Vidro do Touchscreen, Lente da Câmera Traseira, Selo Anatel",
                manual_value_placeholder: "Ex: 1080x2400 AMOLED 120Hz, Sem arranhões",
                clear_golden: "Limpar Comparação",
                golden_cleared: "Comparação com Golden limpa",
                golden_active: "Golden Ativo",
                base_props_loaded: "Propriedades base do dispositivo carregadas com sucesso!",
                all_sections_verified: "Todas as Seções Incluídas Foram Atestadas e Conferidas",
                verified: "Conferido",
                unverified: "Não Conferido",
                verified_tooltip: "Seção atestada/conferida pelo analista",
                unverified_tooltip: "Clique para atestar a verificação desta seção",
                verification_required: "Atestação Obrigatória",
                verification_required_desc: "As seguintes seções ativas no relatório ainda não foram atestadas como conferidas:",
                analyst_name_required: "O nome do analista é obrigatório para gerar o relatório.",
                conforme: "CONFORME",
                nao_conforme: "NÃO CONFORME",
                notes: "Observações",
                click_to_zoom: "Clique na miniatura para ampliar",
                type_image: "Foto / Evidência",
                type_text: "Texto / Especificação",
                value_text: "Valor / Texto de Observação",
                value_image: "Anexar Foto / Captura de Tela",
                change_image: "Trocar Imagem",
                upload_image_btn: "Selecionar Arquivo de Imagem (PNG, JPG, WEBP)...",
                notes_placeholder: "Detalhes adicionais, inspeção de número de série ou defeitos físicos...",
                image_preview: "Visualização de Evidência",
                packages_compare: "Comparação de Pacotes",
                ...
                captured_texts_count: "{{count}} textos capturados",
                expected_texts_count: "{{count}} textos esperados",
                view_captured_texts: "Ver textos capturados",
                hide_captured_texts: "Ocultar textos",
                no_texts_captured_yet: "Nenhum texto capturado ainda. Clique em Executar para inspecionar a tela.",
                no_texts_captured_yet_manual: "Nenhum texto extraído ainda. Clique em \"OCR por IA\" para analisar a imagem anexada.",
                ...
                ai_ocr: "OCR por IA",
                analyze_image_ai: "Analisar textos da imagem com IA",
                extract_texts_ai: "Extrair Textos com IA",
                ai_analyzing_image: "Extraindo textos com IA...",
                analyzing_image_ai: "Analisando imagem com IA...",
                ai_extract_success: "{{count}} textos extraídos via IA!",
                texts_extracted_count: "{{count}} textos extraídos da imagem",
                ai_extract_error: "Falha ao extrair textos com IA: {{error}}",
                ai_extraction_error: "Falha na extração por IA: {{error}}",
                ai_no_texts_found: "Nenhum texto legível foi identificado pela IA.",
                no_texts_found_in_image: "Nenhum texto pôde ser extraído da imagem",
                image_load_error: "Falha ao carregar arquivo de imagem",
                no_image_to_analyze: "Por favor, selecione uma imagem primeiro",
                manual_check_name_required: "O nome do item é obrigatório",
                golden_match: "Conforme Golden",
                golden_mismatch: "Divergente Golden"
            },
            actions: {
                screenshot: "Capturar Tela",
        ...
        companion: {
            connected: "Companion Ativo",
            connected_action: "Companion Ativo — Clique para abrir e conectar",
            connecting: "Conectando ao Companion...",
            not_installed: "Companion Não Instalado",
            not_installed_action: "Companion Não Instalado — Clique para configurar",
            connect: "Conectar Companion",
            disconnected: "Companion Offline",
            launch: "Abrir Companion App",
            launch_connect: "Abrir e Conectar Companion",
            launching: "Iniciando Companion App...",
            launched: "Companion App iniciado",
            launch_error: "Falha ao iniciar Companion App",
            status_title: "Mobile Companion",
            status_desc: "Diagnósticos de hardware diretos e agente mobile de alta velocidade.",
            hardware_diagnostics: "Diagnósticos de Hardware e POS (Companion)",
            connect_to_view: "Conecte o Companion para visualizar os diagnósticos de Hardware",
            connect_desc: "Habilita medição de corrente mA em tempo real, impressora térmica POS, leitor NFC e teste de tela.",
            battery_power: "Medidor de Bateria & Energia",
            current: "Corrente",
            health: "Saúde",
            voltage: "Tensão",
            temp: "Temperatura",
            pos_printer: "Impressora Térmica POS",
            paper_status: "Papel",
            cover_status: "Tampa",
            print_test: "Imprimir Recibo de Teste",
            print_started: "Recibo de teste enviado para a impressora POS",
            print_failed: "Falha ao imprimir recibo de teste",
            nfc_display: "Testes de NFC e Display",
            display_desc: "Dispara calibração de pixels em tela cheia no dispositivo.",
            color_test: "Iniciar Teste de Cores na Tela",
            display_test_started: "Teste de cores ativo na tela do dispositivo",
            display_test_failed: "Falha ao iniciar teste de cores na tela",
            accessibility_status: "Serviço de Acessibilidade",
            enable_accessibility: "Ativar Acessibilidade (1-Clique ADB)",
            accessibility_enabled: "Ativo (Inspeção Sub-10ms)",
            accessibility_disabled: "Desativado",
            accessibility_success: "Serviço de Acessibilidade concedido via ADB",
        ...
        reports_subtab: {
            title: "Relatórios",
            description: "Visualize, pré-visualize e publique relatórios de auditoria e checkup.",
            filter_all: "Todos",
            filter_temporary: "Temporários",
            filter_published: "Publicados",
            search_placeholder: "Buscar por título, dispositivo ou analista...",
            open_reports_folder: "Abrir Pasta /reports",
            publish: "Publicar",
            publishing: "Publicando...",
            published_success: "Relatório publicado com sucesso em /reports!",
            publish_error: "Falha ao publicar relatório em /reports.",
            preview: "Pré-visualizar",
            open_file: "Abrir no Navegador",
            delete: "Excluir",
            delete_confirm: "Tem certeza que deseja excluir este relatório?",
            delete_success: "Relatório removido com sucesso.",
            no_reports_found: "Nenhum relatório encontrado",
            no_reports_desc: "Gere relatórios no Checkup para visualizá-los e publicá-los aqui.",
            temporary_badge: "Temporário",
            temporary_badge_tooltip: "Este relatório está em memória nesta sessão e desaparecerá ao fechar o Robot Runner se não for publicado.",
            published_badge: "Publicado",
            analyst: "Analista",
            device: "Dispositivo",
            date: "Data",
            size: "Tamanho",
            type_checkup: "Checkup de Hardware & OS",
            type_ai_checkup: "Checkup com Análise de IA",
            type_companion_bdd: "Testes BDD do Companion",
            type_custom: "Relatório Geral",
            preview_title: "Pré-visualização do Relatório",
