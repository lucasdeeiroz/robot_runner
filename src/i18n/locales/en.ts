export const en = {
    translation: {
        ...
        performance: {
            ...
            process_error: "Failed to fetch process stats",
            battery_audit: "Battery Audit",
            reset_stats: "Reset Stats",
            audit_description: "Audit power consumption (requires resetting stats before usage/testing for accurate data).",
            reset_success: "Battery stats reset successfully.",
            reset_error: "Failed to reset battery stats.",
            audit_error: "Failed to fetch battery audit.",
            charging: "Charging",
            ...
            capacity: "Capacity",
            computed_drain: "Computed Drain",
            no_app_data: "No app specific data available.",
        ...
        toolbox: {
            ...
            checkup: {
                ...
                run_additional_checks: "Run Additional Checks",
                expected: "Expected",
                found: "Found",
                ...
                report_title: "Device Checkup Report",
                report: {
                    inclusions: "Inclusions",
                    config_title: "Report Configuration",
                    all: "All results",
                    all_desc: "Show both matching and divergent .prop values",
                    divergent: "Only divergent",
                    divergent_desc: "Show only mismatched .prop values",
                    none: "None",
                    none_desc: "Do not show .prop comparisons",
                    show_extra_props: "Show Extra Base Props",
                    show_extra_props_desc: "Include properties from the base file that were not found on the device",
                    show_standard_checks: "Show Standard Checks",
                    show_standard_checks_desc: "Include the results of the standard checks if executed",
                    show_additional_checks: "Show Additional Checks",
                    show_additional_checks_desc: "Include the results of the additional checks if executed",
                    show_packages: "Show Packages",
                    show_packages_desc: "Include the list of installed packages",
                    package_filter_mode: "Package Filter Mode",
                    package_filter_mode_exclude: "Show all except...",
                    package_filter_mode_exclude_desc: "Show all packages, excluding those that start with the prefixes below",
                    package_filter_mode_include: "Show ONLY...",
                    package_filter_mode_include_desc: "Show ONLY the packages that start with the prefixes below",
                    package_filter_none: "No packages",
                    package_filter_none_desc: "Do not show packages",
                    package_prefixes: "Package Prefixes (e.g. com.android)",
                    props_filter_mode: "Property Filter Mode",
                    props_filter_mode_exclude: "Show all except...",
                    props_filter_mode_exclude_desc: "Show all properties, excluding those that start with the prefixes below",
                    props_filter_mode_include: "Show ONLY...",
                    props_filter_mode_include_desc: "Show ONLY the properties that start with the prefixes below",
                    props_filter_none: "No properties",
                    props_filter_none_desc: "Do not show properties",
                ...
                additional: {
                    ...
                    imei_blocked: "Blocked by OS (Shell Restriction)",
                    bluetooth_address: "Bluetooth Address",
                    wifi_mac_address: "Wi-Fi MAC Address",
                    wifi_ip_address: "Wi-Fi IP Address",
                    memory: "Memory (/proc/meminfo)",
