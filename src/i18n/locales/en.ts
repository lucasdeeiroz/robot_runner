export const en = {
    translation: {
        ...
        apps: {
            ...
            update_companion: "Update Companion APK",
            update_companion_tooltip: "Update companion.apk to current release ({{version}})",
            updating_companion: "Opening download link for companion.apk ({{version}})...",
        ...
        commands: {
            ...
            actions: {
                ...
                netstat: "Netstat",
                list_packages: "3rd Party Apps",
                list_all_packages: "All Apps",
                top: "Top Processes",
                battery: "Battery Status",
                reboot: "Reboot",
                uptime: "Uptime",
                device_info: "Device Info",
                dump_ui: "Dump UI Hierarchy",
                screen_size: "Screen Res",
        ...
        common: {
            ...
            pair_grid: "Split with Console",
            check_connection: "Check Connection",
            loading: "Loading...",
            actions_disabled_during_test: "Actions are disabled while a test is running",
            device_offline: "Device is offline or disconnected",
            connect_wifi: "Connect via Wi-Fi",
            connect_wifi_success: "Wi-Fi connection established",
            refresh: "Refresh",
            saved_rounds: "Saved Rounds",
        ...
        toolbox: {
            ...
            checkup: {
                ...
                expected: "Expected",
                found: "Found",
                interactive_tests: "Interactive Hardware Tests",
                live_sync: "Live Sync",
                offline: "Offline",
                no_interactive_tests: "No interactive tests executed yet. Run them on the Companion app.",
                test_scanner: "Scanner",
                test_pixels: "Screen Colors",
                test_touch: "Touch Screen",
                test_vibration: "Vibration",
                test_speaker: "Audio Speaker",
                test_mic: "Microphone",
                test_flash: "Camera Flash",
                test_printer: "Thermal Printer",
                ...
                clear: "Clear",
                golden_file_imported: "Golden file imported successfully!",
                golden_file_import_error: "Failed to import golden file",
                golden_file: {
                    generating: "Generating golden file...",
                    saved: "Golden file saved successfully!",
                    error: "Failed to generate golden file"
                },
                view_full_report_error: "Failed to open HTML report",
                ...
                check_os: "Check OS",
                generate_golden_file: "Generate Golden File",
                import_golden_file: "Import Golden File",
                generating_golden_file: "Generating golden file...",
                base_props: {
                    config_title: "Base Props Configuration",
                    config_desc: "Configure the prefixes used to fetch base properties for the golden file and the properties comparison list.",
                    prefixes: "Prefixes (e.g. ro.build)",
                    add_prefix: "Add prefix..."
                },
                search_config: {
                    config_title: "Search Configuration",
                    config_desc: "Configure search filters for device properties (.prop) and installed packages (apps) for inspection, comparison, and report generation.",
                    props_section_title: "Device Properties (.prop)",
                    props_section_desc: "Property prefixes to be queried and compared (e.g. ro.build, ro.product).",
                    props_prefixes: "Property Prefixes",
                    packages_section_title: "Installed Applications (Packages)",
                    packages_section_desc: "Package filters to be queried and displayed on the interface and reports.",
                    packages_mode_exclude: "Exclude Prefixes",
                    packages_mode_include: "Include Only",
                    packages_prefixes: "Package Prefixes",
                    add_prefix: "Add prefix...",
                    reset_defaults: "Reset Defaults",
                },
                search_config_btn: "Search Settings",
                ...
                report: {
                    ...
                    analyst_placeholder: 'Enter the QA / Hardware Analyst name',
                    analyst_required_warning: 'Mandatory field: The report cannot be generated without the analyst name.',
                    result: 'Final Result',
                    approved: 'Approved',
                    rejected: 'Rejected',
                    pending: 'Pending',
                    ai_evaluating: 'Under AI Evaluation',
                    comments: 'Comments / Notes',
                    comments_placeholder: 'Add general observations, justifications, or test notes...',
                    no_comments: 'No comments recorded.',
                    compliant_summary: '{{count}} matching items',
                    compliant_hidden: 'matching items',
                    unverified_sections_error: 'Please attest/verify (Conferido) all active sections before generating the report: {{sections}}',
                    sections_to_include: 'Sections to Include in Report',
                    prop_compare_title: 'Show .prop Compare',
                    prop_compare_desc: 'Include .prop comparison results if executed',
                    standard_checks_title_alt: 'Show Standard Checks',
                    standard_checks_desc: 'Include standard checks results if executed',
                    additional_checks_title_alt: 'Show Additional Checks',
                    additional_checks_desc: 'Include additional checks results if executed',
                    packages_title_alt: 'Show Packages',
                    packages_desc: 'Include packages check results if executed',
                    companion_bdd_title: 'Companion BDD Tests',
                    companion_bdd_desc: 'Include mobile BDD execution reports',
                    manual_checks_title: 'Manual Checklist',
                    manual_checks_desc: 'Include custom visual inspections & photos',
                    ui_texts_title: 'UI Text Checks',
                    ui_texts_desc: 'Include screen OCR & text validation',
                    interactive_tests_title: 'Interactive Hardware',
                    interactive_tests_desc: 'Include touchscreen & button checks',
                    extra_props_title: 'Show Additional Props',
                    extra_props_desc: 'Include additional device properties',
                    only_divergent: 'Show only not corresponding values',
                    btn_exclude: 'Show all except...',
                    btn_include: 'Show ONLY...',
                    advanced_filters: 'Advanced Filters',
                    packages_filter: 'Package Filter',
                    props_filter: 'Extra Props Filter',
                    inclusions: "Inclusions",
                    config_title: "Report Configuration",
                    all: "All results",
                    all_desc: "Show both matching and divergent .prop values",
                    divergent: "Only divergent",
                    divergent_short: "Divergent",
                ...
                no_packages_found: "No packages found or device not connected.",
                no_props: "No properties loaded. Click \"Import .prop\" or connect Companion.",
                ...
                fetching_packages: "Fetching installed apps...",
                show_only_divergent: "Only Divergences",
                ...
                system: "System",
                user: "User",
                search_pkg: "Search app...",
                companion_bdd_tests: "Companion BDD Tests",
                syncing_companion_tests: "Syncing tests from Companion...",
                no_companion_tests: "No BDD test suites found. Create or execute tests on the Companion app to sync here.",
                manual_checks: "Manual Checklist",
                add_check: "Add Check",
                add_manual_check: "Add Manual Check",
                edit_manual_check: "Edit Manual Check",
                no_manual_checks: "No manual checks added yet. Click \"Add Check\" to record custom hardware/visual inspections.",
                no_ui_text_checks: "No UI text checks configured. Click \"Add\" to set up screen text extraction tests.",
                no_divergences: "No divergences found.",
                value_type: "Evidence / Value Type",
                manual_name_placeholder: "e.g. Touchscreen Glass, Rear Camera Lens, Anatel Label",
                manual_value_placeholder: "e.g. 1080x2400 AMOLED 120Hz, No scratches",
                clear_golden: "Clear Comparison",
                golden_cleared: "Golden comparison cleared",
                golden_active: "Golden Active",
                base_props_loaded: "Base device properties loaded successfully!",
                all_sections_verified: "All Included Sections Attested & Verified",
                verified: "Verified",
                unverified: "Unverified",
                verified_tooltip: "Section verified by analyst",
                unverified_tooltip: "Click to attest verification",
                verification_required: "Verification Required",
                verification_required_desc: "The following active sections in the report have not been verified yet:",
                analyst_name_required: "Analyst name is required to generate the report.",
                conforme: "PASS",
                nao_conforme: "FAIL",
                notes: "Notes",
                click_to_zoom: "Click thumbnail to zoom",
                type_image: "Photo / Evidence",
                type_text: "Text / Specification",
                value_text: "Value / Observation Text",
                value_image: "Attach Photo / Screenshot",
                change_image: "Change Image",
                upload_image_btn: "Select Image File (PNG, JPG, WEBP)...",
                notes_placeholder: "Additional details, serial inspection, or physical defects...",
                image_preview: "Evidence Image Preview",
                ...
                captured_texts_count: "{{count}} captured texts",
                expected_texts_count: "{{count}} expected texts",
                view_captured_texts: "View captured texts",
                hide_captured_texts: "Hide texts",
                no_texts_captured_yet: "No texts captured yet. Click Run to inspect the screen.",
                no_texts_captured_yet_manual: "No texts extracted yet. Click \"AI OCR\" to analyze the attached image.",
                ...
                ai_ocr: "AI OCR",
                analyze_image_ai: "Analyze image texts with AI",
                extract_texts_ai: "Extract Texts with AI",
                ai_analyzing_image: "Extracting texts with AI...",
                analyzing_image_ai: "Analyzing image with AI...",
                ai_extract_success: "Extracted {{count}} texts via AI!",
                texts_extracted_count: "Extracted {{count}} texts from image",
                ai_extract_error: "Failed to extract texts with AI: {{error}}",
                ai_extraction_error: "AI Extraction failed: {{error}}",
                ai_no_texts_found: "No legible texts were found by AI.",
                no_texts_found_in_image: "No text could be extracted from the image",
                image_load_error: "Failed to load image file",
                no_image_to_analyze: "Please select an image first",
                manual_check_name_required: "Check name is required",
                golden_match: "Golden Match",
                golden_mismatch: "Golden Mismatch"
            },
            actions: {
                screenshot: "Take Screenshot",
        ...
        companion: {
            connected: "Companion Active",
            connected_action: "Companion Active — Click to launch & connect",
            connecting: "Connecting to Companion...",
            not_installed: "Companion Not Installed",
            not_installed_action: "Companion Not Installed — Click to setup",
            connect: "Connect Companion",
            disconnected: "Companion Offline",
            launch: "Launch Companion App",
            launch_connect: "Launch & Connect Companion",
            launching: "Launching Companion App...",
            launched: "Companion App launched",
            launch_error: "Failed to launch Companion App",
            status_title: "Mobile Companion",
            status_desc: "Direct hardware diagnostics and high-speed device agent.",
            hardware_diagnostics: "Companion Hardware & POS Diagnostics",
            connect_to_view: "Connect Companion to view Hardware Diagnostics",
            connect_desc: "Enables real-time battery mA meter, POS printer testing, NFC reader check, and display calibration.",
            battery_power: "Battery & Power Meter",
            current: "Current",
            health: "Health",
            voltage: "Voltage",
            temp: "Temp",
            pos_printer: "POS Thermal Printer",
            paper_status: "Paper Status",
            cover_status: "Cover",
            print_test: "Print Test Receipt",
            print_started: "Test receipt sent to POS printer",
            print_failed: "Failed to print test receipt",
            nfc_display: "NFC & Display Tests",
            display_desc: "Launch fullscreen pixel calibration on the device screen.",
            color_test: "Launch Color Calibration",
            display_test_started: "Color test active on device",
            display_test_failed: "Failed to launch display test",
            accessibility_status: "Accessibility Service",
            enable_accessibility: "Enable Accessibility (1-Click ADB)",
            accessibility_enabled: "Active (Sub-10ms UI Dump)",
            accessibility_disabled: "Disabled",
            accessibility_success: "Accessibility Service granted via ADB",
        ...
        reports_subtab: {
            title: "Reports",
            description: "View, preview, and publish audit and checkup reports.",
            filter_all: "All",
            filter_temporary: "Temporary",
            filter_published: "Published",
            search_placeholder: "Search by title, device, or analyst...",
            open_reports_folder: "Open /reports Folder",
            publish: "Publish",
            publishing: "Publishing...",
            published_success: "Report published successfully to /reports!",
            publish_error: "Failed to publish report to /reports.",
            preview: "Preview",
            open_file: "Open in Browser",
            delete: "Delete",
            ...
            no_reports_desc: "Generate reports in Checkup to view and publish them here.",
            temporary_badge: "Temporary",
            temporary_badge_tooltip: "This report is in memory for this session and will disappear on app close if not published.",
            published_badge: "Published",
            analyst: "Analyst",
            device: "Device",
            date: "Date",
            size: "Size",
            type_checkup: "Hardware & OS Checkup",
            type_ai_checkup: "AI Verified Checkup",
            type_companion_bdd: "Companion BDD Tests",
            type_custom: "General Report",
