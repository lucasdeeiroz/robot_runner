    ...
    translation: {
        ...
        settings: {
            ...
            ai: {
                ...
                gemini_code: {
                    title: "Gemini CLI",
                    help: "This provider uses the local 'gemini' command. Ensure you have the Gemini CLI installed and configured.",
                    check_install: "Check Installation",
                    installed: "Gemini CLI detected! Version: {{version}}",
                    not_installed: "Gemini CLI not found. Please install it using 'npm install -g @google/gemini-cli'.",
                    token_label: "API Key",
                    token_placeholder: "Enter Gemini API Key",
                    token_help: "The API Key will be used to authenticate your requests via the Gemini CLI."
                },
