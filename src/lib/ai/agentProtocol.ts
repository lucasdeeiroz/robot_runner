        ...
        actions: {
            ...
            items: {
                ...
                properties: {
                    ...
                    path: { type: "string", description: "File path for run_test." },
                    device: { type: "string", description: "Device serial for device-specific actions." },
...
4. Your text response should be in the "reply" field. Use Markdown for formatting.
5. Provide 2-3 follow-up suggestions in "suggested_prompts".
6. The user is on a desktop app. Do not ask them to use a terminal if you can do it via an action (like execute_adb).
7. VERY IMPORTANT: You must generate your "reply", "description", and "suggested_prompts" in the user's preferred language: ${language}.
