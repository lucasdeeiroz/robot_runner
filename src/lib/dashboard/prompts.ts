...
4. CRITICAL EXHAUSTIVITY RULE: You MUST write an extremely exhaustive suite of test cases. Do NOT just cover the happy path. You MUST generate comprehensive test cases covering Edge Cases, Negative/Sad Paths, Boundary values, Empty States, and Validation rules. Generate at least 10-15 scenarios if applicable, ensuring maximum coverage. You will fail this task if you only provide basic test cases.
