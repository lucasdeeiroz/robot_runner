                ...
                <div className="relative z-10 space-y-4">
                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-4">
                            {response && (
                                <div className={clsx(
                                    "bg-surface/60 p-4 rounded-xl border relative group/suggest shadow-sm",
                            ...
                            {rationale && (
                                <div className="px-4 py-3 bg-primary/5 rounded-xl border border-primary/10 relative group/rationale shadow-sm">
                                    <div className="flex justify-between items-start">
                                        <span className="text-[9px] font-black text-primary/60 uppercase tracking-widest block">
                                            {rationaleHeader}
                                        </span>
