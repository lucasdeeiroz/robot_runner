...
import { Check, Scan, Home, ArrowLeft, Rows, X, Search, Pencil, Copy, ChevronDown, ChevronUp, Videotape, Download, RefreshCw } from 'lucide-react';
...
export function InspectorSubTab({ selectedDevice, isActive, isTestRunning = false }: InspectorSubTabProps) {
    ...
    const handleEditStep = (stepId: number) => {
        ...
        let initialEditingAttr: 'xpath' | 'uiselector' = 'xpath';

        if (step.locator && step.locator.includes('UiSelector()')) {
            initialEditingAttr = 'uiselector';
            if (step.locator.includes('resourceId')) initialAttr = 'resource-id';
            else if (step.locator.includes('description')) initialAttr = 'content-desc';
            else if (step.locator.includes('.text(')) initialAttr = 'text';
            else if (step.locator.includes('className')) initialAttr = 'class';
        } else if (step.locator) {
            if (step.locator.includes('@resource-id=')) initialAttr = 'resource-id';
            else if (step.locator.includes('@content-desc=')) initialAttr = 'content-desc';
            else if (step.locator.includes('@text=')) initialAttr = 'text';
            else if (step.locator.includes('@class=')) initialAttr = 'class';
        } else {
        ...
        setEditingAttr(initialEditingAttr);
